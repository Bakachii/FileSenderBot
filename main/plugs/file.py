...
async def link_generator(client: Client, message: Message):
    while True:
        ...
        if msg_id:
            ...
            await channel_message.reply("This Forwarded Post is not from my DB Channel or this Link is not taken from DB Channel", quote = True)
            continue
    ...
    await message.reply_text(f"• Encoded links\n﹂Link:\n`{link}`\n﹂GpLink:\n`{gplink}`", reply_markup=reply_markup)
